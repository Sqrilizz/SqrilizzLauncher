...
use crate::state::{
    ...
    MemorySettings, /* [AR] Removed: ModrinthCredentials, */ Profile,
    ...
    E: sqlx::Executor<'a, Database = sqlx::Sqlite> + Copy,
{
        ...
        read_json::<LegacySettings>(&settings_path, &io_semaphore).await
    {
        ...
        // [AR] Patch: Disabled Modrinth auth migration
        // Skip migrating Modrinth credentials for offline launcher
