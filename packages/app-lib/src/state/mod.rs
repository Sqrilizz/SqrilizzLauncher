...
// [AR] Patch: Removed tunnel module (depends on friends)
...
pub struct State {
    ...
    // [AR] Patch: Removed friends_socket
...
impl State {
    pub async fn init() -> crate::Result<()> {
        ...
        tokio::task::spawn(async move {
            let res = tokio::try_join!(
                ...
                // [AR] Patch: Removed ModrinthCredentials::refresh_all()
            );
            ...
            // [AR] Patch: Removed friends socket connection
            // let _ = state.friends_socket.connect(...).await;
    ...
    async fn initialize_state() -> crate::Result<Arc<Self>> {
        ...
        // [AR] Patch: Removed friends_socket initialization
