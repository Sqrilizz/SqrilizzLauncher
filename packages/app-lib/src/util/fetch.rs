...
pub async fn fetch_advanced(
    ...
    // [AR] Patch: Disabled Modrinth auth - no authorization headers
    ...
    for attempt in 1..=(FETCH_ATTEMPTS + 1) {
        ...
        // No Modrinth authorization header for offline launcher
    ...
    T: DeserializeOwned,
{
    ...
    // [AR] Patch: Disabled Modrinth auth header
    // Skip authorization for offline launcher
